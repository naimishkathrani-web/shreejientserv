...
async function testPidgeDataApi() {
    ...
    form.append('k1', '2025-11-25', { filename: 'blob', contentType: 'text/plain' });
    form.append('k2', '2025-11-25', { filename: 'blob', contentType: 'text/plain' });
    ...
    try {
        ...
        console.log('Data Preview:', JSON.stringify(response.data, null, 2).substring(0, 2000)); // Limit output
    } catch (error) {
