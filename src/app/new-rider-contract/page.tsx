...
export default function NewRiderContractPage() {
    const { t } = useLanguage();
    ...
    if (submitted) return (<div className="min-h-screen bg-gray-50 py-12 px-4"><div className="container mx-auto max-w-2xl text-center"><div className="bg-white rounded-lg shadow-lg p-6"><div className="text-green-600 text-5xl mb-3">✓</div><h3 className="text-2xl font-bold mb-2">{t('contract.success.app_title')}</h3><p className="text-gray-600 mb-4">{t('contract.success.message')}</p><a href="/" className="inline-block bg-purple-600 text-white px-6 py-2 rounded-lg font-semibold hover:bg-purple-700">{t('nav.home')}</a></div></div></div>);

    return (
        <div className="min-h-screen bg-gray-50 py-6 px-4">
            <div className="container mx-auto max-w-4xl">
                <div className="bg-white rounded-lg shadow p-4 mb-4">
                    <h1 className="text-2xl font-bold mb-2">{t('contract.new_title')}</h1>
                ...
                <form onSubmit={handleSubmit} noValidate className="bg-white rounded-lg shadow p-4 space-y-3">
                    ...
                    <button type="submit" className="w-full bg-purple-600 text-white px-6 py-3 rounded-lg font-semibold hover:bg-purple-700 mt-3">{t('contract.submit_app')}</button>
                </form>
            </div>
        </div>
    );
