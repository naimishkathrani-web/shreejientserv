...
class LanguageManager {
    ...
    getTranslation(key, langCode) {
        ...
        const translations = {
            ...
            // Hero Section
            'hero.title': {
                'en': 'Your Trusted Manpower Supply Partner',
                'hi': 'आपका विश्वसनीय मैनपावर आपूर्ति भागीदार',
                'gu': 'તમારો વિશ્વાસુ મેનપાવર સપ્લાય પાર્ટનર',
                'mr': 'तुमचा विश्वासार्ह मॅनपावर पुरवठा भागीदार',
                'ta': 'உங்கள் நம்பகமான மனிதவளத் தொழிலாளர் துணைவர்',
                'te': 'మీ నమ్మకమైన మానవశక్తి సరఫరా భాగస్వామి',
                'kn': 'ನಿಮ್ಮ ವಿಶ್ವಾಸಾರ್ಹ ಮಾನವಶಕ್ತಿ ಪೂರೈಕೆ ಪಾಲುದಾರ',
                'ml': 'നിങ്ങളുടെ വിശ്വസ്ത മനുഷ്യശക്തി വിതരണ പങ്കാളി',
                'bn': 'আপনার বিশ্বস্ত মানবসম্পদ সরবরাহ অংশীদার',
                'pa': 'ਤੁਹਾਡਾ ਭਰੋਸੇਮੰਦ ਮਨੁੱਖੀ ਸ਼ਕਤੀ ਸਪਲਾਈ ਸਾਥੀ'
            },
            'hero.subtitle': {
                'en': 'Connecting talented professionals with leading companies across India and globally',
                'hi': 'भारत और विश्वभर की प्रमुख कंपनियों के साथ प्रतिभाशाली पेशेवरों को जोड़ना',
                'gu': 'ભારત અને વૈશ્વિક સ્તરે અગ્રણી કંપનીઓ સાથે પ્રતિભાશાળી પ્રોફેશનલ્સને જોડવા',
                'mr': 'भारत आणि जागतिक स्तरावर आघाडीच्या कंपन्यांसह प्रतिभावान व्यावसायिकांना जोडणे',
                'ta': 'இந்தியா மற்றும் உலகளவில் முன்னணி நிறுவனங்களுடன் திறமையான தொழிலாளர்களை இணைத்தல்',
                'te': 'భారతదేశం మరియు ప్రపంచవ్యాప్తంగా ప్రముఖ కంపెనీలతో ప్రతిభావంతమైన నిపుణులను కలుపుతోంది',
                'kn': 'ಭಾರತ ಮತ್ತು ಜಾಗತಿಕವಾಗಿ ಪ್ರಮುಖ ಕಂಪನಿಗಳೊಂದಿಗೆ ಪ್ರತಿಭಾವಂತ ವೃತ್ತಿಪರರನ್ನು ಸಂಪರ್ಕಿಸುವುದು',
                'ml': 'ഇന്ത്യയിലും ആഗോളതലത്തിലും മുൻനിര കമ്പനികളുമായി കഴിവുള്ള പ്രൊഫഷണലുകളെ ബന്ധിപ്പിക്കുന്നു',
                'bn': 'ভারত এবং বিশ্বজুড়ে নেতৃস্থানীয় কোম্পানির সাথে প্রতিভাবান পেশাদারদের সংযুক্ত করা',
                'pa': 'ਭਾਰਤ ਅਤੇ ਗਲੋਬਲੀ ਤੌਰ ਤੇ ਅਗਵਾਈ ਕੰਪਨੀਆਂ ਨਾਲ ਪ੍ਰਤਿਭਾਸ਼ਾਲੀ ਪੇਸ਼ੇਵਰਾਂ ਨੂੰ ਜੋੜਨਾ'
            },
            'hero.btn_services': {
                'en': 'Our Services',
                'hi': 'हमारी सेवाएं',
        ...
        // Merge with homepage translations if available
        if (typeof homepageTranslations !== 'undefined' && homepageTranslations[key]) {
            return homepageTranslations[key][langCode] || null;
        }
