...
$contractEmailSubject = "Contract Accepted - New Rider Activation In Progress - $firstName $lastName";
$activationEmailSubject = "Your Activation Is In Progress - Next Steps";

// Create comprehensive CONTRACT ACCEPTANCE email body with legal declaration
$contractEmailBody = "
<!DOCTYPE html>
<html lang='en'>
<head>
...
// Create ACTIVATION IN PROGRESS email body
$activationEmailBody = "
<!DOCTYPE html>
<html lang='en'>
<head>
    ...
    <style>
        ...
        .welcome-box { background: #f0f4ff; border-left: 4px solid #667eea; padding: 20px; margin: 20px 0; border-radius: 5px; }
        .timeline { margin: 30px 0; }
        .timeline-item { display: flex; margin-bottom: 25px; position: relative; }
        .timeline-number { min-width: 40px; height: 40px; background: #667eea; color: white; border-radius: 50%; display: flex; align-items: center; justify-content: center; font-weight: bold; margin-right: 20px; }
        .timeline-content { flex: 1; }
        .timeline-content h3 { margin: 0 0 10px 0; color: #667eea; font-size: 18px; }
        .timeline-content p { margin: 0; color: #666; }
        .important-notice { background: #fff3cd; border: 2px solid #ffc107; padding: 20px; border-radius: 8px; margin: 20px 0; }
        .important-notice h3 { margin: 0 0 10px 0; color: #856404; }
        .contact-box { background: #e8f5e9; padding: 20px; border-radius: 8px; margin: 20px 0; }
        .contact-box h3 { margin: 0 0 15px 0; color: #2e7d32; }
...
<body>
    <div class='container'>
        <div class='header'>
            <h1>🎉 Welcome to Shreeji Enterprise Services!</h1>
            <p style='margin: 10px 0 0 0; font-size: 16px;'>Your Application Is Being Processed</p>
        </div>
        
        <div class='content'>
            <div class='welcome-box'>
                <h2 style='margin-top: 0; color: #667eea;'>Dear $firstName $lastName,</h2>
                <p style='font-size: 16px; margin-bottom: 0;'>
                    Congratulations! We have received your contract acceptance and your new rider activation process has begun. 
                    Thank you for choosing to partner with us!
                </p>
            </div>
            
            <h2 style='color: #333;'>📋 What Happens Next?</h2>
            <p>Your application will go through the following steps:</p>
            ...
            <div class='timeline'>
                <div class='timeline-item'>
                    ...
                    <div class='timeline-content'>
                        ...
                        <p><strong>Duration:</strong> 1-2 business days<br>
                        Our team will verify your Aadhar ($maskedAadhar), PAN ($maskedPAN), and other submitted documents. 
                        We may contact you if additional information is needed.</p>
                    </div>
                </div>
                ...
                <div class='timeline-item'>
                    ...
                    <div class='timeline-content'>
                        ...
                        <p><strong>Duration:</strong> 2-3 business days<br>
                        Standard background checks will be conducted as per company policy. This is a routine process for all new riders.</p>
                    </div>
                </div>
                ...
                <div class='timeline-item'>
                    ...
                    <div class='timeline-content'>
                        <h3>Platform Training & Onboarding</h3>
                        <p><strong>Duration:</strong> 1 day<br>
                        You'll receive training on the Pedge mobile app, delivery protocols, MDND policy, and best practices. 
                        Training location: $workLocation</p>
                    </div>
                </div>
                ...
                <div class='timeline-item'>
                    ...
                    <div class='timeline-content'>
                        <h3>Account Activation & Trial Period Start</h3>
                        <p><strong>Duration:</strong> Immediate after training<br>
                        Your account will be activated on the Pedge platform and you can begin your 3-month trial period. 
                        You'll receive login credentials and start date via SMS and email.</p>
                    </div>
                </div>
            </div>
            ...
            <div class='important-notice'>
                ...
                <ul style='margin: 10px 0; padding-left: 20px;'>
                    <li><strong>Total Processing Time:</strong> Typically 4-7 business days</li>
                    <li><strong>Keep Your Phone Accessible:</strong> We'll contact you at $mobileNumber</li>
                    <li><strong>Vehicle Readiness:</strong> Ensure your $vehicleType is in good condition with valid documents</li>
                    <li><strong>First Contract Email:</strong> You've already received a separate email with complete terms and conditions. Please review it carefully.</li>
                </ul>
            </div>
            ...
            <div class='contact-box'>
                ...
                <p>
                    <strong>WhatsApp/Call:</strong> +91-7016899689 (Mon-Sat, 9 AM - 6 PM)<br>
                    <strong>Email:</strong> info@shreejientserv.in<br>
                    <strong>HR Department:</strong> hr@shreejientserv.in
                </p>
                <p style='margin-top: 15px; font-size: 14px;'>
                    <em>Our team is here to support you throughout the activation process. Don't hesitate to reach out!</em>
                </p>
            </div>
            ...
            <div style='text-align: center; margin: 30px 0;'>
                ...
                <p style='color: #666;'>
                    You'll receive updates at each stage of the process. Keep an eye on your email and phone.
                </p>
            </div>
        </div>
        
        <div class='footer'>
            <h3 style='color: #667eea; margin: 0 0 10px 0;'>Shreeji Enterprise Services</h3>
            <p>
                📍 714 The Spyre 2 Sheetal Park, 150 Feet Ring Road, Rajkot, Gujarat - 360005<br>
                📞 +91-7016899689 | ✉️ info@shreejientserv.in | 🌐 www.shreejientserv.in
            </p>
            <p style='margin-top: 15px; font-size: 11px;'>
                © 2024 Shreeji Enterprise Services. All rights reserved.<br>
