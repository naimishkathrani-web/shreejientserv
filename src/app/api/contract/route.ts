...
<body>
  ...
  <p>Thank you for accepting the Freelance Rider Agreement with Shreeji Enterprise Services. This email confirms your acceptance and contains a summary of the contract terms you have agreed to.</p>
  ...
  <div class="footer">
    ...
    <p>Email: info@shreejientserv.in | Phone: +91 73830 60401</p>
        ...
        return NextResponse.json({ success: false, error: 'Failed to process contract' }, { status: 500 });
    }
}
